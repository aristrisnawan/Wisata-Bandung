...
import 'package:farm_house_lembang/detail_screen.dart';
import 'package:farm_house_lembang/model/tourism_place.dart';
...
class MainScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: tourismPlaceLism.map((place){
      return FlatButton(
        onPressed: (){
...
var tourismPlaceLism = [
  TourismPlace(
      ...
      imageAsset: 'https://media-cdn.tripadvisor.com/media/photo-s/0d/7c/59/70/farmhouse-lembang.jpg',
      imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'https://media-cdn.tripadvisor.com/media/photo-o/12/6b/63/0b/bosscha-observatory.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'https://media-cdn.tripadvisor.com/media/photo-o/0d/c2/e7/e6/quotes-kota-bandung.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'https://media-cdn.tripadvisor.com/media/photo-o/15/01/d7/4b/p-20180510-153310-01.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'https://media-cdn.tripadvisor.com/media/photo-o/08/8b/87/50/bandung-movie-park.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'https://media-cdn.tripadvisor.com/media/photo-w/19/1c/8e/f7/geology-museum.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 20000',
    imageAsset: 'https://media-cdn.tripadvisor.com/media/photo-o/17/f9/ff/f8/floating-market-bandung.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'https://media-cdn.tripadvisor.com/media/photo-o/0b/6e/7c/ce/rocks-sticking-out-of.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Rp 20000',
    imageAsset: 'https://media-cdn.tripadvisor.com/media/photo-o/1a/e0/7f/9c/kampung-cai-ranca-upas.jpg',
    imageUrls: [
